...
import {createProfile,getProfile} from '../../actions/userprofileAction';
...
export default connect(mapStateToProps, { createProfile,getProfile })(withRouter(CreateProfile));
